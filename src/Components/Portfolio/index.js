...
class Portfolio extends React.Component {
    ...
    render() {
        return (
            ...
            <a href="https://res.cloudinary.com/dtaene1s4/raw/upload/v1720921351/Resume_Recent_hw7rfs.docx" className="button github-right"><i class='bx bxs-download'></i> Resume</a>
