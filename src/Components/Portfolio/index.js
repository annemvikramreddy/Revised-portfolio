...
class Portfolio extends React.Component {
    ...
    render() {
        return (
            ...
            <a href="https://res.cloudinary.com/dtaene1s4/raw/upload/v1719355088/Resume_Recent_1_crsbq4.docx" className="button github-right"><i class='bx bxs-download'></i> Resume</a>
