...
class Portfolio extends React.Component {
    ...
    render() {
        return (
            ...
            <a href="https://res.cloudinary.com/dtaene1s4/raw/upload/v1732558195/Vikram_Reddy_Annem-_editing_pmxhfw.docx" className="button github-right"><i class='bx bxs-download'></i> Resume</a>
